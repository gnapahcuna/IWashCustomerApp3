...
class _BranchContactState extends State<MyBranchContact> {
  ...
  Widget _buildContent() {
    return Latitude!=null?SingleChildScrollView(
      child: Column(
    ...
    Container(
      ...
      child: Center(
        child: Text('ไม่สามารถแสดงข้อมูลส่วนนี้ได้ เนื่องจากคุณยังไม่อนุญาติให้เข้าถึงตำแหน่ง',style: TextStyle(color: cl_text_pro_en,
            fontSize: 14.0,
                          ...
                          children: <Widget>[
                            new Expanded(child: Padding(
                              padding: EdgeInsets.only(
                                  top: 6.0, left: 16.0, bottom: 6.0),
                              child: Text(
                                  branch[0].Contact == null ? '-' : branch[0]
                                      .Contact,
                                  style: TextStyle(
                                      color: cl_text_pro_th,
                                      fontSize: 16.0,
